    ...
    <div class="container mt-2">
        <div class="card">
            <div class="card-header">
                Хамгаалалтын зурвас зөрчсөн хэрэглэгч засах
            </div>
            <div class="card-body">
                    ...
                    <div class="row">
                                ...
                                <div class="form-group mb-3">
                                    <select id="branch-dropdown" name="branch_id" class="form-control">
                                        @foreach ($branches as $branch)
                                            <option value="{{ $branch->id }}" {{ old('branch_id', $violation->branch_id) == $branch->id ? 'selected' : '' }}>
                                                {{ $branch->name }}
                                            </option>
                                        @endforeach
                                    </select>
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" name="maintainer_name" class="form-control" value="{{ $violation->maintainer_name }}">
