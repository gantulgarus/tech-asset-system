...
@section('content')
    <div class="container mt-2">
        <div class="row">
            <div class="col-lg-12 margin-tb">
                <div class="pull-right">
                    <a class="btn btn-secondary text-white" href="{{ route('cause_outages.index') }}"> Буцах</a>
                </div>
            </div>
        </div>
        <br />
        <div class="card">
            <div class="card-body">
                <form action="{{ route('cause_outages.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                        <div class="col-md-6">
                            <div class="mb-3">
