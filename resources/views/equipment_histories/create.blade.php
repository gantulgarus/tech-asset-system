...
@section('content')
    <div class="container mt-2">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <form action="{{ route('equipment-histories.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                                ...
                                <div class="form-group mb-3">
                                    <select name="equipment_id" class="form-control" disabled>
                                        ...
                                        @foreach ($equipments as $equipment)
                                            <option value="{{ $equipment->id }}" {{ $equipment_id == $equipment->id ? 'selected' : '' }}>
                                                {{ $equipment->name }}
                                            </option>
                                        @endforeach
                                    </select>
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input id="task_date" type="text" name="task_date" class="form-control" value="{{ old('task_date') }}">
                                @error('task_date')
                                    <div class="alert alert-danger mt-1 mb-1">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" name="work_type" class="form-control" value="{{ old('work_type') }}">
                                @error('work_type')
                                    <div class="alert alert-danger mt-1 mb-1">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" name="completed_task" class="form-control" value="{{ old('completed_task') }}">
