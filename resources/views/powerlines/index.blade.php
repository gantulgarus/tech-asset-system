    ...
    <div class="container-fluid">
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <button type="button" class="btn btn-secondary btn-sm mb-2" id="reset-filters"><i class="fas fa-undo-alt"></i>
                    Цэвэрлэх</button>
                            ...
                            <tr class="align-middle">
                                ...
                                <th>
                                    <select name="line_type" class="form-select form-select-sm">
                                        <option></option>
                                        <option value="ЦДАШ" {{ request('line_type') == 'ЦДАШ' ? 'selected' : '' }}>ЦДАШ
                                        </option>
                                        <option value="ЦДКШ" {{ request('line_type') == 'ЦДКШ' ? 'selected' : '' }}>
                                            ЦДКШ</option>
                                    </select>
                                </th>
                                <th>
                                    <input type="text" name="powerline" class="form-control form-control-sm"
                                        value="{{ request('powerline') }}">
                                </th>
                                <th>
                                ...
                                <th>
                                    <input type="text" id="create_year" name="create_year"
                                        class="form-control form-control-sm" value="{{ request('create_year') }}">

                                </th>

                                <th>
                                    <input type="text" id="line_mark" name="line_mark"
                                        class="form-control form-control-sm" value="{{ request('line_mark') }}">
                                </th>
                                <th>
                                    <input type="text" id="tower_mark" name="tower_mark"
                                        class="form-control form-control-sm" value="{{ request('tower_mark') }}">
                                </th>
                                <th></th>
                                <th></th>
                                <th>
                                    <input type="text" id="isolation_mark" name="isolation_mark"
                                        ...
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-end">
                                                <a class="dropdown-item"
                                                    href="{{ route('powerlines.show', $powerline) }}">Харах</a>
                                                <a class="dropdown-item"
                                                    href="{{ route('powerlines.edit', $powerline) }}">Засах</a>
                                                <form action="{{ route('powerlines.destroy', $powerline) }}"
                                                    method="POST">
                                                    @csrf
                                                    @method('DELETE')
