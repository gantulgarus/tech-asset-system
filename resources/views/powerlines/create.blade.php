                    ...
                    <div class="row">
                            ...
                            <div class="mb-3">
                                ...
                                <div class="form-group mb-3">
                                    <select id="type-dropdown" name="line_type" class="form-control">
                                        <option value="ЦДАШ" {{ old('line_type') == 'ЦДАШ' ? 'selected' : '' }}>ЦДАШ</option>
                                        <option value="ЦДКШ" {{ old('line_type') == 'ЦДКШ' ? 'selected' : '' }}>ЦДКШ</option>
                                    </select>
                                </div>
                                @error('line_type')
                                    <div class="alert alert-danger mt-1 mb-1">{{ $message }}</div>
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="number" name="muft_count" class="form-control" value="{{ old('muft_count') }}">
                                @error('muft_count')
                                    <div class="alert alert-danger mt-1 mb-1">{{ $message }}</div>
                                @enderror
                            </div>
