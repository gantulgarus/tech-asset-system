                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="datetime-local" name="reduction_time" class="form-control" id="reduction_time" onchange="calculateEnergyNotSupplied()">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="mb-3">
                                <label for="reduced_capacity" class="form-label">Хөнгөлсөн чадал, (МВт)</label>
                                <input type="number" step="any" name="reduced_capacity" class="form-control" id="reduced_capacity" onchange="calculateEnergyNotSupplied()">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="mb-3">
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="datetime-local" name="restoration_time" class="form-control" id="restoration_time" onchange="calculateEnergyNotSupplied()">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="mb-3">
                                <label for="energy_not_supplied" class="form-label">Дутуу түгээсэн ЦЭХ (кВт.ц)</label>
                                <input type="number" step="any" name="energy_not_supplied" class="form-control" id="energy_not_supplied">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="mb-3">
