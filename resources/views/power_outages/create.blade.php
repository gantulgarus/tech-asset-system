                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <textarea id="incident_resolution" name="incident_resolution" class="form-control">{{ old('incident_resolution') }}</textarea>
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="number" name="disconnected_users" class="form-control" value="{{ old('disconnected_users') }}">
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" name="create_user" class="form-control" value="{{ old('create_user') }}">
                                @error('create_user')
                                    <div class="alert alert-danger mt-1 mb-1">{{ $message }}</div>
                                @enderror
                            </div>
