...
@section('content')
    <div class="container mt-2">
        <div class="card">
            ...
            <div class="card-body">
                <form action="{{ route('power_failures.update', $powerFailure) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    <div class="row">
                        <div class="col-md-6">
                                ...
                                <div class="form-group mb-3">
                                    <select id="station-dropdown" name="station_id" class="form-control">
                                        ...
                                        @foreach ($stations as $station)
                                            <option value="{{ $station->id }}" {{ old('station_id', $powerFailure->station_id) == $station->id ? 'selected' : '' }}>
                                                {{ $station->name }}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="form-group mb-3">
                                    <select id="equipment-dropdown" name="equipment_id" class="form-control">
                                        ...
                                        @foreach ($equipments as $equipment)
                                            <option value="{{ $equipment->id }}" {{ old('equipment_id', $powerFailure->equipment_id) == $equipment->id ? 'selected' : '' }}>
                                                {{ $equipment->name }}
                                            </option>
                                        @endforeach
                                    </select>
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input id="failure_date" type="text" name="failure_date" class="form-control" value="{{ $powerFailure->failure_date }}">
                                @error('failure_date')
                                    <div class="alert alert-danger mt-1 mb-1">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" name="detector_name" class="form-control" value="{{ $powerFailure->detector_name }}">
                                @error('detector_name')
                                    <div class="alert alert-danger mt-1 mb-1">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" name="notified_name" class="form-control" value="{{ $powerFailure->notified_name }}">
                                @error('notified_name')
                                    <div class="alert alert-danger mt-1 mb-1">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" name="action_taken" class="form-control" value="{{ $powerFailure->action_taken }}">
                                @error('action_taken')
                                    <div class="alert alert-danger mt-1 mb-1">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" name="fixer_name" class="form-control" value="{{ $powerFailure->fixer_name }}">
                                @error('fixer_name')
                                    <div class="alert alert-danger mt-1 mb-1">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" name="inspector_name" class="form-control" value="{{ $powerFailure->inspector_name }}">
