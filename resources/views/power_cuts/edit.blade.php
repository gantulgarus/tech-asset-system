                    ...
                    <div class="row">
                                ...
                                <div class="form-group mb-3">
                                    <select id="cause-dropdown" name="cause_cut_id" class="form-control">
                                        ...
                                        @foreach ($causeCuts as $cause)
                                            <option value="{{ $cause->id }}" {{ old('cause_cut_id', $powerCut->cause_cut_id) == $cause->id ? 'selected' : '' }}>
                                                {{ $cause->name }}
                                            </option>
                                        @endforeach
                                    </select>
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="number" name="current_voltage" class="form-control" value="{{ $powerCut->current_voltage }}">
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="number" name="current_amper" class="form-control" value="{{ $powerCut->current_amper }}">
                                @error('current_amper')
                                    <div class="alert alert-danger mt-1 mb-1">{{ $message }}</div>
                                @enderror
                            </div>
